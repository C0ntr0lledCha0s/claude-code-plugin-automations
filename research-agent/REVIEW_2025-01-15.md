...
### vs. Claude Component Builder
| Aspect | Research Agent | Claude Component Builder |
|--------|----------------|--------------------------|
...
**Lesson**: Follow claude-component-builder's pattern for validation and resources.
