...
**Templates:**
- `claude-component-builder/skills/building-agents/templates/agent-template.md` - Basic agent template
- `claude-component-builder/skills/building-agents/templates/agent-checklist.md` - Quality review checklist

**Scripts:**
- `claude-component-builder/skills/building-agents/scripts/validate-agent.py` - Schema validation
- `claude-component-builder/skills/building-agents/scripts/create-agent.py` - Interactive generator
- `claude-component-builder/skills/building-agents/scripts/enhance-agent.py` - Quality analyzer
- `claude-component-builder/skills/building-agents/scripts/migrate-agent.py` - Schema migrator

**References:**
- `claude-component-builder/skills/building-agents/references/agent-examples.md` - Real-world examples
- `claude-component-builder/skills/building-agents/references/agent-update-patterns.md` - Update scenarios
