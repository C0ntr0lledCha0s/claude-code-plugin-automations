...
**Templates:**
- `claude-component-builder/skills/building-hooks/templates/hooks-template.json` - Basic structure
- `claude-component-builder/skills/building-hooks/templates/event-patterns/` - Event-specific patterns

**Scripts:**
- `claude-component-builder/skills/building-hooks/scripts/validate-hooks.py` - Schema validation
- `claude-component-builder/skills/building-hooks/scripts/create-hooks.py` - Interactive generator
- `claude-component-builder/skills/building-hooks/scripts/enhance-hooks.py` - Security analyzer
- `claude-component-builder/skills/building-hooks/scripts/migrate-hooks.py` - Schema migrator

**References:**
- `claude-component-builder/skills/building-hooks/references/hook-examples.md` - Real examples
- `claude-component-builder/skills/building-hooks/references/security-patterns.md` - Security best practices
