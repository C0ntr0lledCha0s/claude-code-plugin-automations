...
**Templates:**
- `claude-component-builder/skills/building-commands/templates/command-template.md` - Basic template
- `claude-component-builder/skills/building-commands/templates/command-patterns/` - Common patterns

**Scripts:**
- `claude-component-builder/skills/building-commands/scripts/validate-command.py` - Schema validation
- `claude-component-builder/skills/building-commands/scripts/create-command.py` - Interactive generator
- `claude-component-builder/skills/building-commands/scripts/enhance-command.py` - Quality analyzer
- `claude-component-builder/skills/building-commands/scripts/migrate-command.py` - Schema migrator

**References:**
- `claude-component-builder/skills/building-commands/references/command-examples.md` - Real examples
- `claude-component-builder/skills/building-commands/references/argument-patterns.md` - Argument handling
