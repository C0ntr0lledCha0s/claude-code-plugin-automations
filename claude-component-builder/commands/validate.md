...
### Validate an Agent
```
/claude-component-builder:validate .claude/agents/code-reviewer.md
```

### Validate a Skill
```
/claude-component-builder:validate .claude/skills/analyzing-code/
```

### Validate a Command
```
/claude-component-builder:validate .claude/commands/run-tests.md
```

### Validate Hooks
```
/claude-component-builder:validate .claude/hooks.json
```
