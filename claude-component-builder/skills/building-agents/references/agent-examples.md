...
**Key Points:**
- Color `blue` matches the review/analysis domain
...
**Key Points:**
- Color `red` matches the testing/QA domain
...
**Key Points:**
- Color `orange` matches the security domain
...
**Key Points:**
- Color `green` matches the documentation domain
...
**Key Points:**
- Color `purple` matches the meta/advisor domain
...
| Agent Type | Recommended Color |
|------------|------------------|
| Orchestrators/Meta | `purple` |
| Code Analysis/Git | `blue` |
| Testing/QA | `red` |
| Security | `orange` |
| Documentation | `green` |
| Performance/Data | `cyan` |
| Self-Improvement | `pink` |
| Planning/Caution | `yellow` |
