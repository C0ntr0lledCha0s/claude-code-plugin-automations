...
│   └─ Run: /claude-component-builder:agents:enhance my-agent
...
**Migration**:
```bash
/claude-component-builder:agents:update my-agent
> 3 (model)
...
**Migration**:
```bash
/claude-component-builder:agents:enhance my-agent
...
```bash
python3 claude-component-builder/skills/building-agents/scripts/validate-agent.py my-agent.md
```
...
```bash
python3 claude-component-builder/skills/building-agents/scripts/enhance-agent.py my-agent
```
...
```bash
python3 claude-component-builder/skills/building-agents/scripts/update-agent.py my-agent
```
...
```bash
# Audit to prioritize
/claude-component-builder:agents:audit
...
4. **Review examples**:
   Check `claude-component-builder/skills/building-agents/references/agent-examples.md`
