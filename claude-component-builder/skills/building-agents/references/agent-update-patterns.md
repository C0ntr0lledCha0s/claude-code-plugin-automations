...
**Solution**:
```bash
/claude-component-builder:update my-agent
...
**Solution**:
```bash
/claude-component-builder:enhance my-agent
...
# Compare two agents
/claude-component-builder:compare agent-a agent-b

# Audit all agents
/claude-component-builder:audit
```
