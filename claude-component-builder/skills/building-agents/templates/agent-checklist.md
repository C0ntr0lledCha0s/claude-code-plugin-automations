...
python3 claude-component-builder/skills/building-agents/scripts/enhance-agent.py agent-name

# Comparison (if similar agents exist)
/claude-component-builder:agents:compare agent-name similar-agent
```
