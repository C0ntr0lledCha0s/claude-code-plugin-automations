...
### Update Skill
```bash
/claude-component-builder:skills:update <skill-name>
```
...
### Enhance Skill
```bash
/claude-component-builder:skills:enhance <skill-name>
```
...
### Migrate Skill
```bash
/claude-component-builder:skills:migrate <skill-name> --apply
```
...
**Solution**:
```bash
/claude-component-builder:skills:migrate my-skill --apply
```
...
**Solution**:
```bash
chmod +x claude-component-builder/skills/my-skill/scripts/*.py
chmod +x claude-component-builder/skills/my-skill/scripts/*.sh
```
...
3. Enhance: `/claude-component-builder:skills:enhance my-skill`
4. Address recommendations
5. Re-validate and test

### Updating an Existing Skill
1. Analyze: `/claude-component-builder:skills:enhance my-skill`
2. Update: `/claude-component-builder:skills:update my-skill`
3. Validate changes
4. Test auto-invocation

### Migrating Skills
1. Preview: `/claude-component-builder:skills:migrate --dry-run`
2. Apply: `/claude-component-builder:skills:migrate --apply`
...
### Commands
- `/claude-component-builder:skills:update` - Update configuration
- `/claude-component-builder:skills:enhance` - Get quality score
- `/claude-component-builder:skills:migrate` - Migrate schema
...
```bash
# Analyze quality
/claude-component-builder:skills:enhance my-skill

# Update interactively
/claude-component-builder:skills:update my-skill

# Remove model field (critical)
/claude-component-builder:skills:migrate my-skill --apply

# Validate schema
python3 claude-component-builder/skills/building-skills/scripts/validate-skill.py my-skill/

# Make scripts executable
chmod +x my-skill/scripts/*.py

# Preview migrations
/claude-component-builder:skills:migrate --dry-run
```
