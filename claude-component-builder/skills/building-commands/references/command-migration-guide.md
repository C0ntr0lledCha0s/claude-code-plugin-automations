...
/claude-component-builder:commands:migrate --dry-run

# Migrate single command (preview)
/claude-component-builder:commands:migrate my-command

# Migrate single command (apply)
/claude-component-builder:commands:migrate my-command --apply

# Migrate all commands (interactive, with confirmation)
/claude-component-builder:commands:migrate --apply
```
...
```bash
python3 claude-component-builder/skills/building-commands/scripts/validate-command.py my-command.md
```
...
# All commands
/claude-component-builder:commands:audit
```
...
```bash
/claude-component-builder:commands:enhance my-command
```
...
- [ ] Run `/claude-component-builder:commands:migrate --dry-run` to see what needs updating
- [ ] Fix critical issues first (model field, required fields)
- [ ] Run `/claude-component-builder:commands:migrate my-command --apply` or update manually
- [ ] Validate with `/claude-component-builder:commands:audit`
- [ ] Test command execution
- [ ] Check enhancement score `/claude-component-builder:commands:enhance my-command`
...
- Try with full path: `/claude-component-builder:commands:migrate ./path/to/command.md`
...
python3 claude-component-builder/skills/building-commands/scripts/enhance-command.py my-command

# Compare with backup to see what changed
/claude-component-builder:commands:compare my-command my-command.md.bak
```
...
**Fix**:
```bash
/claude-component-builder:commands:update my-command
> Select: 3 (model)
...
```bash
/claude-component-builder:commands:audit --verbose
```
...
```bash
/claude-component-builder:commands:update <command-name>
```
...
```bash
/claude-component-builder:commands:enhance <command-name>
```
...
3. Compare with working commands: `/claude-component-builder:commands:compare my-command working-command`
