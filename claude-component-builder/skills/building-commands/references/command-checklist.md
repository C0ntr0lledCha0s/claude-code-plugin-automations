...
**Quick Check**: Run `/claude-component-builder:commands:enhance <command-name>` for automated scoring against many of these criteria.
...
- [ ] Quality score ≥ 6: `/claude-component-builder:commands:enhance my-command`
...
- [ ] Run validation: `/claude-component-builder:commands:audit`
- [ ] Run enhancement: `/claude-component-builder:commands:enhance <command-name>`
...
/claude-component-builder:commands:compare my-command template-command
```
