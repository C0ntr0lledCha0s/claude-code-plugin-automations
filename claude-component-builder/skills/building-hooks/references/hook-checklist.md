...
for file in $(git diff --cached --name-only | grep 'hooks.json'); do
  ...
  python3 claude-component-builder/skills/building-hooks/scripts/enhance-hook.py "$file"
  ...
  security_score=$(python3 claude-component-builder/skills/building-hooks/scripts/enhance-hook.py "$file" 2>&1 | grep "Security:" | awk '{print $2}' | cut -d'/' -f1)
...
- **Validation Script**: `claude-component-builder/skills/building-hooks/scripts/validate-hooks.py`
- **Enhancement Analyzer**: `claude-component-builder/skills/building-hooks/scripts/enhance-hook.py`
- **Migration Tool**: `claude-component-builder/skills/building-hooks/scripts/migrate-hook.py`
- **Audit Tool**: `claude-component-builder/skills/building-hooks/scripts/audit-hooks.py`
- **Comparison Tool**: `claude-component-builder/skills/building-hooks/scripts/compare-hooks.py`
- **Documentation**: `claude-component-builder/skills/building-hooks/SKILL.md`
