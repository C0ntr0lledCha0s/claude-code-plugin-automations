...
- Follow [relevant standards/conventions]
...
When the user asks [specific request], you should:
1. [Step 1]
2. [Step 2]
3. [Step 3]
...
When faced with [situation], you should:
1. [Step 1]
2. [Step 2]
3. [Step 3]
...
- Always [important constraint or guideline]
- Never [what to avoid]
